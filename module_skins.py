...
#     ("manface_old_2",0xffd5d5c5,["hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
    ...
    [(voice_die,"snd_trolloc_die"),(voice_hit,"snd_trolloc_hit"),(voice_grunt,"snd_trolloc_grunt"),(voice_grunt_long,"snd_trolloc_grunt_long"),(voice_yell,"snd_trolloc_yell"),(voice_stun,"snd_trolloc_stun"),(voice_victory,"snd_trolloc_victory")], #voice sounds
    "skel_human", 1.25, # 1.0
    psys_game_blood_black,psys_game_blood_2_black,
    [[1.7, comp_greater_than, (1.0,face_width), (1.0,temple_width)], #constraints: ex: 1.7 > (face_width + temple_width)
     [0.3, comp_less_than, (1.0,face_width), (1.0,temple_width)],
     [1.7, comp_greater_than, (1.0,face_width), (1.0,face_depth)],
     [0.3, comp_less_than, (1.0,eyebrow_height), (1.0,eyebrow_position)],
...
#     ("manface_old_2",0xffd5d5c5,["hair_white"],[0xffffcded, 0xffbbcded, 0xff99eebb]),
    ...
    [(voice_die,"snd_myrddraal_die"),(voice_hit,"snd_myrddraal_hit"),(voice_grunt,"snd_myrddraal_grunt"),(voice_grunt_long,"snd_myrddraal_grunt_long"),(voice_yell,"snd_myrddraal_yell"),(voice_stun,"snd_myrddraal_stun"),(voice_victory,"snd_myrddraal_victory")], #voice sounds
    "skel_human", 1.0,
    psys_game_blood_black,psys_game_blood_2_black,
    [[1.7, comp_greater_than, (1.0,face_width), (1.0,temple_width)], #constraints: ex: 1.7 > (face_width + temple_width)
     [0.3, comp_less_than, (1.0,face_width), (1.0,temple_width)],
