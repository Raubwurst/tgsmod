...
## end TGS books
 ...
 all your money, and ride off into the sunset....",
  ...
  (
    ...
    "{s2} You have {reg10} troops fit for battle against their {reg11}. {s4}", ## PreBattle Orders & Deployment adds {s4}
    "none",
    [
...
##            (eq, ":random_attribute", ca_intelligence),
  ...
  (
    "join_battle",0,
    "You are helping the {s2} against the {s1}. You have {reg10} troops fit for battle against the enemy's {reg11}. {s4}",  ## PreBattle Orders & Deployment adds {s4}
    "none",
    [
...
#           (assign, "$g_talk_to_village_elder_by_menu", 1),
#         (try_end),
#        ],"Door to the village center."),
#SW - Talk to village elder END

      ## end edited for TGS (removed for now because it has been added in diplomacy)
      ...
      "Take a walk around the streets.",
       [
         ...
         (else_try),
           ...
           (else_try),
         ## modified for TGS
             (assign,reg0,"trp_illian_swordsman"), # was trp_vaegir_infantry
             (assign,reg1,"trp_illian_swordsman"), # was trp_vaegir_infantry
             (assign,reg2,"trp_murandy_bowman"), # was trp_vaegir_archer
             (assign,reg3,"trp_altara_dueler"), # was trp_vaegir_footman
         ## end modified for TGS
           (try_end),
           (shuffle_range,0,4),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
      ...
      [
       ...
       [
         ...
         (else_try),
             ### edited for TGS
           (assign, "$talk_context", tc_town_talk), # was tc_town_talk
             ### end edited for TGS
...
##          ]),
      ...
      ##diplomacy begin (use diplo code for TGS)
	...
	[
	 ...
	 ##nested diplomacy end+
	  ##diplomacy end   (use diplo code for TGS)
      ("town_leave",[],"Leave...",
      [
        (assign, "$g_permitted_to_center",0),
        (change_screen_return,0),
    ...
    [
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
		   ...
		   ## Each stat is chance/100 of presence in tournament. arg1 = horse_chance, arg2 = lance_chance (with horse only), arg3 = sword_chance, arg4 = axe_chance, arg5 = bow_chance (without horse only), arg6 = javelin_chance, arg7 = mounted_bow_chance (with horse only), arg8 = crossbow_sword_chance, arg9 = armor_item_begin, arg10 = helm_item_begin
...
#             (try_end),
             ...
             (call_script, "script_set_items_for_tournament", -1, -1, -1, 20, 30, 90, -1, -1, "itm_arena_tunic_red", "itm_arena_turban_red"),
           (else_try),
             # Tear
             (eq, ":town_original_faction", "fac_kingdom_10"),
             (call_script, "script_set_items_for_tournament", 80, -1, 60, -1, -1, -1, -1, -1, "itm_arena_tunic_red", -1),
           (else_try),
             # Saldea
             (eq, ":town_original_faction", "fac_kingdom_10"),
             (call_script, "script_set_items_for_tournament", 80, 40, 50, 10, 10, -1, 80, 10, "itm_arena_armor_red", "itm_arena_helmet_red"),
           (else_try),
             # Shienar
             (eq, ":town_original_faction", "fac_kingdom_10"),
             (call_script, "script_set_items_for_tournament", 80, 60, 40, 20, 10, -1, -1, -1, "itm_arena_armor_red", "itm_arena_helmet_red"),
           (else_try),
             # Arafel
             (eq, ":town_original_faction", "fac_kingdom_10"),
             (call_script, "script_set_items_for_tournament", 30, 10, 90, -1, 50, -1, -1, -1, "itm_arena_tunic_red", -1),
           (else_try),
             # Whitecloaks
             (eq, ":town_original_faction", "fac_kingdom_10"),
             (call_script, "script_set_items_for_tournament", 70, 80, 60, -1, 30, -1, -1, 20, "itm_arena_armor_red", "itm_arena_helmet_red"),
           (else_try),
             # Madmen
             (eq, ":town_original_faction", "fac_kingdom_10"),
    ...
    [
      ("continue",[],"Continue...",
       [
         (try_for_range, ":npc", companions_begin, companions_end),
           (main_party_has_troop, ":npc"),
		   ##diplomacy start+ to avoid problems do not separate the spouse
		   (neg|troop_slot_eq, "trp_player", slot_troop_spouse, ":npc"),
		   ##diplomacy stop+
           (store_random_in_range, ":rand", 0, 100),
           (lt, ":rand", 30),
...
#########################
  ...
  (
    ...
    [
        ...
        # Ten Nations Waygates
		("menu02",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 2),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_karindi_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Ancohima Waygate"),
		("menu03",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 3),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_tanchico_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Mainelle Waygate"),
		("menu04",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 4),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_cairhien_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Al'cair'rahienallen Waygate"),
		("menu05",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 5),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_fal_dara_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Mafal Dadaranell Waygate"),
		("menu06",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 6),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_aridhol_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Aridhol Waygate"),
		("menu07",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 7),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_new_braem_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Braem Waygate"),
		("menu08",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 8),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_caemlyn_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Hai Caemlyn Waygate"),
		("menu09",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 9),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_so_eban_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Londaren Cor Waygate"),
		("menu10",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 10),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_ebou_dar_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Barashta Waygate"),
		("menu11",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 11),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_illian_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Dorelle Caromon Waygate"),
		("menu12",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 12),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_far_madding_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Aren Mador Waygate"),
		("menu13",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 13),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_tear_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Tear Waygate"),
		("menu14",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 14),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_maradon_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Deranbar Waygate"),
        ("menu15",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 15),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_emonds_field_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Manetheren Waygate"),
        ("menu16",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 16),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_south_two_rivers_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Jara'copan Waygate"),
        ("menu17",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 17),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_jehannah_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Shanaine Waygate"),
        ("menu18",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 18),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_katar_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Iman Waygate"),
        ("menu19",[(eq, "$g_show_all_ways", 1)],"ERROR: WAYS.CODE.{$g_ways_point}",[(assign, "$g_ways_point", 19),(assign, "$g_ways_entered", 1),(party_relocate_near_party, 0, "p_tar_valon_gate"),(finish_mission),(leave_encounter),(change_screen_return,0),(jump_to_menu, "mnu_gateway_menu")],"Tar Valon Waygate"),
...
# Emonds Field Raid Event Book 1
		...
		("emonds_field_raid_event_book_1_night_protagonist",[
			...
			[
                ...
                (set_visitors, 1, "trp_two_rivers_farmer", 8),
                (set_visitors, 1, "trp_rivers_townsman", 8),
                (set_visitors, 1, "trp_rivers_townswoman", 8),
                (set_visitors, 1, "trp_farmer", 8),
                (set_visitors, 1, "trp_peasant_woman", 8),
                (set_visitors, 1, "trp_two_rivers_longbowman", 4),
                (set_visitors, 1, "trp_two_rivers_spearman", 2),

                (set_visitor, 2, "trp_master_luhan_book_1"),
                (set_visitors, 2, "trp_two_rivers_farmer", 8),
                (set_visitors, 2, "trp_rivers_townsman", 8),
                (set_visitors, 2, "trp_rivers_townswoman", 8),
                (set_visitors, 2, "trp_farmer", 8),
                (set_visitors, 2, "trp_peasant_woman", 8),
                (set_visitors, 2, "trp_two_rivers_longbowman", 4),
                (set_visitors, 2, "trp_two_rivers_spearman", 2),

                (set_visitor, 3, "trp_bran_al_vere_book_1"),
                (set_visitors, 3, "trp_two_rivers_farmer", 8),
                (set_visitors, 3, "trp_rivers_townsman", 8),
                (set_visitors, 3, "trp_rivers_townswoman", 8),
                (set_visitors, 3, "trp_farmer", 8),
                (set_visitors, 3, "trp_peasant_woman", 8),
                (set_visitors, 3, "trp_two_rivers_longbowman", 4),
                (set_visitors, 3, "trp_two_rivers_spearman", 2),

                (set_visitor, 4, "trp_abell_cauthon_book_1"),
                (set_visitors, 4, "trp_two_rivers_farmer", 8),
                (set_visitors, 4, "trp_rivers_townsman", 8),
                (set_visitors, 4, "trp_rivers_townswoman", 8),
                (set_visitors, 4, "trp_farmer", 8),
                (set_visitors, 4, "trp_peasant_woman", 8),
                (set_visitors, 4, "trp_two_rivers_longbowman", 4),
                (set_visitors, 4, "trp_two_rivers_spearman", 2),

                (set_visitor, 5, "trp_nynaeve_book_1"),
                (set_visitors, 5, "trp_two_rivers_farmer", 8),
                (set_visitors, 5, "trp_rivers_townsman", 8),
                (set_visitors, 5, "trp_rivers_townswoman", 8),
                (set_visitors, 5, "trp_farmer", 8),
                (set_visitors, 5, "trp_peasant_woman", 8),
                (set_visitors, 5, "trp_two_rivers_longbowman", 4),
                (set_visitors, 5, "trp_two_rivers_spearman", 2),

                (set_visitor, 6, "trp_myrddraal"),
                (set_visitors, 6, "trp_shadowspawn_recruit_creature", 3),
                (set_visitors, 6, "trp_trolloc_grunt", 4),
                (set_visitors, 6, "trp_trolloc_archer", 4),
                (set_visitors, 6, "trp_trolloc_hewer", 4),

                (set_visitor, 7, "trp_trolloc_clan_chief"),
                (set_visitors, 7, "trp_shadowspawn_recruit_creature", 3),
                (set_visitors, 7, "trp_trolloc_grunt", 4),
                (set_visitors, 7, "trp_trolloc_archer", 4),
                (set_visitors, 7, "trp_trolloc_hewer", 4),

                (set_visitor, 8, "trp_trolloc_berserker"),
                (set_visitors, 8, "trp_shadowspawn_recruit_creature", 3),
                (set_visitors, 8, "trp_trolloc_grunt", 4),
                (set_visitors, 8, "trp_trolloc_archer", 4),
                (set_visitors, 8, "trp_trolloc_hewer", 4),

                (set_visitor, 9, "trp_trolloc_clan_chief"),
                (set_visitors, 9, "trp_shadowspawn_recruit_creature", 3),
                (set_visitors, 9, "trp_trolloc_grunt", 4),
                (set_visitors, 9, "trp_trolloc_archer", 4),
                (set_visitors, 9, "trp_trolloc_hewer", 4),

                (set_visitor, 10, "trp_trolloc_berserker"),
                (set_visitors, 10, "trp_shadowspawn_recruit_creature", 3),
                (set_visitors, 10, "trp_trolloc_grunt", 4),
                (set_visitors, 10, "trp_trolloc_archer", 4),
                (set_visitors, 10, "trp_trolloc_hewer", 4),
