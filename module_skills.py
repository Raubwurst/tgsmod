...
skills = [
  ...
  ("air","Air",sf_base_att_int,10,"Boosts the strength and/or duration of weaves when channeling with weaves of Air. (Personal skill)"), 
  ("fire","Fire",sf_base_att_int,10,"Boosts the strength and/or duration of weaves when channeling with weaves of Fire. (Personal skill)"), 
  ("water","Water",sf_base_att_int,10,"Boosts the strength and/or duration of weaves when channeling with weaves of Water. (Personal skill)"), 
  ("earth","Earth",sf_base_att_int,10,"Boosts the strength and/or duration of weaves when channeling with weaves of Earth. (Personal skill)"), 
  ("spirit","Spirit",sf_base_att_int,10,"Boosts the strength and/or duration of weaves when channeling with weaves of Spirit. (Personal skill)"), 
]
