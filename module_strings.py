...
## TGS: V: Begin pretender dialogue rewrite
  ...
  ("kingdom_11_pretender_story_1", "After Rand al'Thor saved Caemlyn from Lord Brend, I was eternally grateful. Not only had Morgase gone, the Dragon Reborn claimed to have avenged her death on one of the Forsaken, themselves! Despite the constant shocks, I was pleased knowing that such a strong and able young man was protecting us."),
  ...
  ("kingdom_11_rebellion_monarch_response_2",  "Arymilla can like it or not, but I am the only true Queen of Andor. Arymilla is of no threat, do not encourage her."),
