...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 and you sit a throne in your own splendourous palace as one of the most powerful figures in these lands."),
...
#npc16 = hammaes
  ...
  ("npc2_intro", "Hello there! Come, come, share a drink with me!"),
  ("npc3_intro", "Captain. Come, speak with me."),
...
#backstory intro {sir/madame}
  ...
  ("npc13_backstory_a", "You have not? Then perhaps you will have heard of my steed, who cuts across the plains like a beam of moonlight? Or of my sword, a connoisseur of the blood of the highest-born princes of the land?"),
  ...
  ("npc16_backstory_a", "Well, {sir/madame}, I've spent the last couple of years searching for the Horn of Valere."), # mat
...
#backstory main body
  ...
  ("npc5_backstory_b", "For as long as any one can remember, our people have feuded with the tribe of Humyan, many of whom have settled in the next valley over. Many men have died in this feud, on both sides, including two of my brothers. The Khan himself has ordered us to cease, to save men for the wars in the land. But I know my rights, and my brothers' blood cries out for vengeance. I waylaid and killed a Humyan on a track over the mountains, and I rode out of our village the same night, without even having had the chance to bid farewell to my father. I will bide my time, for a year or two, then return home when the Khan's men have forgotten. The Humyan will not forget, of course, but such is the price of honour."),
...
#backstory recruit pitch
  ...
  ("npc7_backstory_c", "But I do not count myself unlucky, stranger, no more than any other woman of this land, this fetid backwater, this dungheap among the nations, populated by apes and jackals."),
...
### use these if there is a short period of time between the last meeting
  ...
  ("npc6_backstory_later", "I have been wandering the land, but have yet to find redemption."),
  ("npc7_backstory_later", "I have been wandering, looking for work as a tracker, but it has not been easy. These people are mostly ill-bred, lice-ridden, and ignorant, and it is not easy to work with them."),
  ...
  ("npc12_backstory_later", "I have been here and about, tending to the sick and taking what reward I can. But the people of these parts are ignorant, and have little respect for my craft. The few crowns I make are barely enough for me to replenish my stock of medicine. I should be grateful for the chance to find other work."),
  ("npc13_backstory_later", "I have been wandering through the cities of the land, leaving a string of love-sick women and cuckolded husbands in my wake. But I grow weary of such simple challenges, and had been thinking of turning myself to more martial pastimes."),
  ...
  ("npc3_signup", "Yes, I can talk and kill. Or talk and kill at the same time? Who would notice, in these times of chaos?"),
...
#11
  ...
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} crowns from you. It's an advice my father gave me. He told me 'Baheshtur, never fight for a barbarian before {he/she} pays you your worth of gold first'."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} crowns first. You aren't expecting me to work for free, do you?"),
  ("npc8_payment", "Then I will fight your enemies for you. But first I want a bounty of {reg3} crowns. If you are a worthy captain who can lead {his/her} company to riches and plunder, you should have no trouble paying. I cannot afford to follow a pauper."),
  ("npc9_payment", "That's very good of you. And before I join, can you lend me {reg3} crowns, so that I can buy some proper clothing that befits a gentleman of noble birth such as myself. The coat on me has been worn down badly due to my recent bad fortune, and I cannot let common soldiers mistake me as one of their own."),
  ("npc10_payment", "That's good news. But I'll ask for one last thing, captain. I have a woman here in {s20}, a tavern wench, and she says she has my child in her belly. I want to give her some money before I leave... for the child, you know. Do you think you can spare {reg3} crowns?"),
  ("npc11_payment", "Hey thank you captain. But before joining up with you, I would ask for a payment of {reg3} crowns. I know that in war parties soldiers can go on for weeks without seeing any wages. I am wise enough not to sign anywhere without having myself covered."),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} crowns. Do you think that you could cover those for me, as a gesture of friendship?"),
  ("npc14_payment", "Ah, one last thing. I would ask for an initial bounty of {reg3} crowns before I join your command. It's my principle never to enter someone's service without receiving the payment I deserve."),
  ...
  ("npc5_payment_response", "Well... here's {reg3} crowns, then. Your first payment."),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "No, of course not. Here's {reg3} crowns."),
  ("npc8_payment_response", "Oh, I am no pauper, madame. Here's {reg3} crowns for you."),
  ("npc9_payment_response", "Very well, here's {reg3} crowns."),
  ("npc10_payment_response", "Of course. Here, {reg3} crowns."),
  ("npc11_payment_response", "Very well, here's {reg3} crowns. Make yourself ready. We leave soon."),
  ("npc12_payment_response", "{!}."),
  ("npc13_payment_response", "Of course, here's {reg3} crowns. Make ready to leave soon."),
  ("npc14_payment_response", "All right, here's {reg3} crowns. You are most welcome in our company."),
  ("npc15_payment_response", "All right, here's {reg3} crowns. Glad to have you with us."),
  ...
  ("npc3_morality_speech", "Now, now, Captain: there is no need to {s21}. Our Master does not wholly approve of that, even in the company of Lightblinded fools."),
  ...
  ("npc13_morality_speech", "Captain, if we can avoid it, I'd prefer not to {s21}. This is a small place, and one's reputation is precious. I would not care for one of my rivals to include this latest unfortunate incident in a satirical verse."),
  ...
  ("npc2_2ary_morality_speech", "I hate it when we {s21}. Why hold back, when we could smash them completely, face to face?"),
  ("npc3_2ary_morality_speech", "I am glad we {s21}. Being an Aes Sedai of the - ahem - Grey, I do approve of that."),
  ...
  ("npc16_2ary_morality_speech", "Friend -- just so you know, it's no problem by me that we {s21}. We do what we need to do to live, and they'd do the same to us if they were in our shoes."),
  ...
  ("npc3_personalityclash_speech", "Captain, I demand you demote {s11} to a more... fitting ...position. She is a wilder, underserving of a place beside us."),
...
### set off by behavior after victorious battle
  ...
  ("npc2_personalityclash2_speech", "I'd request that you keep me on the other side of the battlefield of that black-eyed Aiel, {s11}."),
  ...
  ("npc4_personalitymatch_speech", "How refreshing it is to meet an Ogier again, why the last time I met one, it was for purely political purposes - he was refusing to Sing a throne for a minor lord, after he hung a man for attempting to steal his horse. I do so love to pick their brains, these Ogier - so much of our laws have been lost, though they still apply."),
  ("npc5_personalitymatch_speech", "That was a fine battle, {playername} Bahadur! {s11} is a good man to have by our side in a fight."),
  ("npc6_personalitymatch_speech", "Captain. Sometimes I am troubled by all this bloodshed, although I know that proud warlords must be humbled, and cruel bandits tamed, if we are to restore peace."),
  ...
  ("npc7_retirement_speech", "I am tired of this squalid life of endless warfare, seeing men debased by fear, greed, lust, and a hundred other sins. I have money in my purse. I am going overseas to look for a better land. I assume that you will fare well without me."),
  ...
  ("npc10_retirement_speech", "I've had enough of tromping up and down the length and breadth of the land. I've got enough to buy a small bit of land somewhere, so I think I'll give that a try. So long, and best of luck to you."),
  ...
  ("npc12_retirement_speech", "I've done all right in your company. I filled my belly, put some gold in my purse, and broadened my knowledge of wounds and injury -- I can't complain about that! But I think right now that service in this company is holding me back. I have a duty to share my findings with other surgeons, and for that I need to hire scribes, who are rare in these lands. I shall be going home"),
  ...
  ("npc7_rehire_speech", "Captain! It is good to see you. Forgive what I may have said when we parted. I took a ship out of Wercheg, bound for the east, but it was taken by pirates and after my ransom I was set ashore back here. There may be better places in the world, but I have yet to see them. So I think, if it is my lot to live here, then your company is as good a livelihood as any. Will you have me back?"),
...
#local color strings
  ...
  ("npc9_home_intro", "Behold the Rock of Rivacheg! The strongest fortress in the land. My father was one of those who held the line here against the Nords, when they first tried to push inland from the coast."),
  ...
  ("npc8_home_description", "You haven't heard the story? When Gundig Hairy-Breeks came to Calradia from Nordland, he planted his banner on the headland and said that it would remain there until he recaptured his 'inheritance.' His 'inheritance', he called it. Gundig believed the skalds who told him that the Emperor had bequeathed the land to the Nords, when in fact he just gave us a small strip of land along the coast, so that we would crew his galleys."),
  ...
  ("npc11_home_description", "I'm from Uxkhal. You know the saying, {sir/madame} -- 'Barley grown in Uxkhal is made into ale in Praven, and we're all the better for it.' Not sure what that means, {sir/madame}, but it's true about the barley. And wheat, and oats. We grow more grain here in the Vale of Uxkhal then all the rest of the land put together, and our ale is the best, too. You can see it in the soil here -- rich and black, and smells of good harvests and full bellies."),
  ("npc12_home_description", "The lord over there in Almerra Castle had the dropsy, and had requested a doctor from Uxkhal to treat him. Like a typical university-educated doctor, he went right to Galerian for a cure. Galerian commends sun-metal for dropsy. Now most of Galerian's writings were useless back in the days of the emperors when they were first written down, and they're doubly worthless today, but sometimes he hits upon the right cure by chance: sun-metal does cure some kinds of dropsy in small doses. However, sun-metal in large doses is poison, something that the Galerian-worshippers never grasped."),
#  ("npc13_home_description", "I had come up here with a small Swadian force, but they were caught by the Rhodoks in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ...
  ("npc10_home_description_2", "We grow mulberry trees here for silk and kermes too for the dye. We take it to Jelkala where they weave it into the finest velvet -- not that I have ever had enough crowns in my pocket to buy velvet, mind. But the craftsmen of Jelkala also make good crossbows, and for that I'll not begrudge them their little luxuries"),
  ("npc11_home_description_2", "The Swadian king will tell you that Praven was the biggest city in the land back under the Empire, and that's why he should rule the whole land today. Mind you, I don't care much about politics, {sir/madame} -- I've sold provisions to every army that ever marched in these lands, and I tell you that I wouldn't give a single one of them a single biscuit unless I had the cold, hard crowns in my hand first. Why these high and mighty kings and nobles can't pay their bills, I'll never know. But I prattle on a bit, there, don't I?"),
  ...
  ("npc14_home_description_2", "If anyone were ever to unify this little land of ours, I'd sign up to serve them, free of charge. I'd put together an army of Rhodok spears with Nord footmen on the flanks and Vaegir archers in front, take along some Khergit scouts to find and fix the enemy, and some Swadian lancers and Sarranid mamlukes to finish them off. I'd take that army over the mountains and make the whole world kneel to this land.... Of course, that's what the Emperors thought, and in the end the tribes took away their Empire."),
  ...
  ("npc9_home_recap", "I am from the Vaegir homeland over the mountains, where the Vaegir lords lived before the Emperor brought them in."),
  ...
  ("npc9_kingsupport_2", "I would, {sir/madame}, and others would too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, these lands are a mess -- the lord owns the land, except it's the king who owns the forest, but the city has the right to levy tax at its gates, and the commons can use the pastures on odd Tuesdays, except in Rivacheg when it's Wednesday. Who can remember? So I say you make things simple, like it was in the old days -- first the {king/sovereign}, then the lords, then everyone else."), #Alayen
  ...
  ("npc12_kingsupport_2", "Of course, captain.  But if I have learned anything in my travels in this land, it is that these people are sticklers for precedent. Everything must be done as it was done in the days of the old Empire -- even though not more than one in a hundred of them can read enough Old Tongue to understand the chronicles! Veluca merchants marry their daughters according to the 'imperial' rite. Rivacheg cattle herders churn 'imperial' butter. And of course, every king must be crowned according to 'imperial' law."), #jeremus
  ...
  ("npc14_kingsupport_2", "I would indeed, sir. I think you can unite this land, and then we'll be able to raise an army such as these lands have not seen for many generations -- Swadian lances, Vaegir archers, Rhodok spears, Sarranid swords, Nord axes, and Khergit skirmishers, and take it over the mountains to subdue all the lands that the emperors once held sway."), #lazalit
  ...
  ("npc2_kingsupport_2", "I can part with you for a few weeks, to talk to the, ah, uncommited types who may have interest in seeing such dreams become a reality. Many of them are men of political power, though they hide their real Power."), #marnid
...
## TODO: Objections, Intel, Fifes, Woman2Woman, TurnAgainst
  ...
  ("npc14_kingsupport_objection", "I understand that you've sent your man Borcha to proclaim to all the land that you intend to free all the miscreants of this land upon your accession to the throne. What a foul idea... Men must be governed, {sir/madame} -- with whips and chains and the noose, if necessary. You'll find that out the hard way if you become {king/queen}, I'll warrant."), #lezalit
...
#
  ...
  ("npc7_fief_acceptance", "Aye, I'll hold {s17} -- and give it a reputation that strikes fear in the hearts of thieves and brigands across the land. Thank you, {sire/madame}, for this opportunity."), #deshavi
  ...
  ("npc11_fief_acceptance", "Ay! You'd grant old Katrin a title of nobility? Well, I'd be daft to turn you down, now wouldn't I? My, the strange turns that life takes... Fancy this old bag of bones becoming a great peer of the realm."), #katrin
  ("npc12_fief_acceptance", "Well, {sire/my lady}, I'd have you know that don't believe in the holding of land in fief to the king. Farmers and landholders should govern their own affairs, under the distant watch of the sovereign. That being said, these lands have seen far too much bloodshed for us to turn the social order on its head right now. Give me that land, and I'll endeavor to prepare it for a brighter future -- if not in this generation, than perhaps in the next."), #jeremus
  ...
  ("npc13_turn_against", "It is sad to meet you as my enemy, Captain -- but on the other hand, to meet such a titan of the battlefield as yourself in combat is a rare privilege. Truly, the news of our contest today shall keep the bards and gleemen in wine and silver for months to come, do you think?"), #nizar
  ("npc14_turn_against", "Well, {playername}. We meet as enemies. I confess that I have mixed feelings. It grieves me to make war on you, but if we meet in battle and I prevail, I will have defeated the worthiest foe in these lands, and I will know that my mastery of the military art is complete!"), #lazalit
...
("comment_intro_female_noble_pitiless", "I see that you carry a noble's banner, but I do not recognize the device... You should know, lady, that here it is the men's right to ride to war, and if you seek to overturn the natural order of things, you will find your fair head stuck on a pike -- like that of any other rebel!"),
("comment_intro_female_noble_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields, but neither is it usual. I shall be most interested in your progress."),
...
("comment_intro_female_common_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields, but neither is it usual. I shall be most interested in your progress."),
...
("rejoinder_intro_female_noble_sadistic", "Never mind my country. Here, it seems, dogs lead men to war."),
...
## TGS: V: Begin pretender dialogue rewrite
  ...
  ("vaegir_rebellion_pretender_intro",   "My name is Colavere, of House Saighan. I look for assistance in reclaiming what is now called the Southlander Coalition."),
  ("khergit_rebellion_pretender_intro",  "I am Arymilla, of House Marne, rightful leader of Andor and the Southlander Alliance."),
  ...
  ("khergit_rebellion_pretender_story_1", "After Rand al'Thor saved Caemlyn from Lord Brend, I was eternally grateful. Not only had Morgase gone, the Dragon Reborn claimed to have avenged her death on one of the Forsaken, themselves! Despite the constant shocks, I was pleased knowing that such a strong and able young man was protecting us."),
  ...
  ("khergit_rebellion_pretender_story_3",  "With their help, I raised a great army to return the Andoran land to it's people. During this time, Rand al'Thor set Elayne of House Trakand on the throne as his puppet. With the best interest of Andor, we fought until the last to drive any man's puppet from ruling our lands. Unfortunately, Elayne managed to capture us and though I managed to make an escape, my house is in ruin and my friends are imprisoned or executed. We must remove Elayne from the throne! She is a puppet of a man, that is not how Andor is ruled. The people do not realize, but we do, and as the educated and well-born know, the common tend to be blind to such intricacies of politics. Would you pledge your sword to me? I am but one woman, of delicate sensibility. I need a hero who will regain Caemlyn and the Southlander Alliance in the name of their Queen!"),
  ...
  ("khergit_rebellion_monarch_response_1",  "I am the only rightful Queen of Andor, my mother holding the throne before me. I was raised in a conventional succession."),
  ...
  ("khergit_rebellion_monarch_response_2",  "Arymilla can like it or not, but I am the only true Queen of Andor. Arymilla is of no threat, do not encourage her."),
...
#courtship
  ...
  #altered for wheel of time
  ("kingdom_1_adjective",                     "Legion"),
  ("kingdom_2_adjective",                     "Southland Confederate"),
  ("kingdom_3_adjective",                     "Southland Ally"),
  ("kingdom_4_adjective",                     "Borderland"),
  ("kingdom_5_adjective",                     "White Tower"),
  ("kingdom_6_adjective",                     "Aiel"),
  #end altered for wheel of time
  #added for wheel of time
  ("kingdom_7_adjective",                     "Seanchan"),
  ("kingdom_8_adjective",                     "Shadowspawn"),
...
#multiplayer game type names
  ...
  ("swadians", "Legionmen"),
  ("vaegirs", "Southlander Comrads"),
  ("khergits", "Southlander Allies"),
  ("nords", "Borderlanders"),
  ("rhodoks", "Aes Sedai"),
  ("sarranids", "Aiel"),
  ...
  ("you_speak_of_unifying_calradia_well_i_believe_that_well_always_be_fighting__its_important_that_we_fight_for_a_rightful_cause", "You speak of unifying these lands. Well, I believe that we'll always be fighting - it's important that we fight for a rightful cause."),
  ...
  ("you_speak_of_unifying_calradia_well_youve_done_a_good_job_at_making_calradia_bend_its_knee_to_you_so_maybe_thats_not_just_talk", "You speak of unifying these lands. Well, you've done a good job at making men bend their knees to you, so maybe that's not just talk."),
  ("you_speak_of_unifying_calradia_id_be_impressed_if_i_thought_you_could_do_it_but_unfortunately_you_dont", "You speak of unifying these lands. I'd be impressed if I thought you could do it. But unfortunately, you don't."),
  ...
  ("you_speak_of_unifying_calradia_well_much_of_this_land_now_bends_its_knee_to_you_so_perhaps_that_is_not_just_talk", "You speak of unifying these lands. Well, much of this land now bends its knee to you, so perhaps that is not just talk."),
  ("you_speak_of_unifying_calradia_but_right_now_yours_is_just_one_squabbling_faction_among_many", "You speak of unifying these lands, but right now yours is just one squabbling faction among many."),
  ...
  ("you_speak_of_unifying_calradia_well_many_have_said_that_you_might_very_well_be_the_one_to_do_it", "You speak of unifying these lands. Well, many have said that, you might very well be the one to do it."),
  ("you_speak_of_unifying_calradia_well_all_the_kings_say_that_im_not_sure_that_you_will_succeed_while_they_fail", "You speak of unifying these lands. Well, all the kings say that. I'm not sure that you will succeed while they fail."),
  ...
  ("you_speak_of_unifying_calradia_but_you_are_weak_and_i_think_that_you_will_remain_weak", "You speak of unifying these lands. But you are weak, and I think that you will remain weak."),
  ...
  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying these lands. Well, maybe you can unite this land by the sword. But I'm not sure that this will make you a good ruler."),
  ...
  ("you_speak_of_unifying_calradia_it_would_be_good_to_bring_peace_to_the_realm_and_i_believe_that_you_are_strong_enough_to_do_so", "You speak of unifying these lands. It would be good to bring peace to the realm, and I believe that you are strong enough to do so."),
...
#diplomacy end+
  ...
  ("outside_calradia", "outside these lands."),
...
##diplomacy end+
  ...
  ("that_you_are_the_rightful_heir_to_the_throne_of_calradia", "That you are the rightful heir to the throne of these lands?"),
  ("that_s14_is_the_rightful_ruler_of_calradia", "That {s14} is the rightful ruler of these lands?"),
  ...
  ("khan", "khan"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom, {s45} should be {s47}"),
...
##diplomacy start+ gender correction
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in these lands, {she/he} will organize the wedding feast."),
##diplomacy end+
...
##diplomacy end+
  ...
  ("you_will_not_be_disappointed_sirmadam_you_will_not_find_better_warriors_in_all_calradia", "You will not be disappointed {sir/madam}. You will not find better warriors, anywhere."),
...
("the_coast", "the coast"),
  ...
  ("s12s15_declared_war_to_control_calradia", "{s12}{s15} may attack {s16} without pretext, as a bid to extend control over all of the land."),
...
#diplomacy end+
  ("s21_the_s8_declared_war_as_part_of_a_bid_to_conquer_all_calradia", "{s21}. The {s8} declared war with very little pretext, as part of a bid to conquer all the land."),
...
###################################################################################
 ...
 #TODO: customize responses by relation and/or personality
  ...
  ("dplmc_reg6my_reg7spouse", "{reg6?My:my} {reg7?love:{husband/wife}}"),
...
#Channeling usage comments
  ...
  ("channeling_help", "Press 'Caps Lock' to toggle active weave. Press 'Numpad 7' to change toggle style to 'Short Range Weaves'. Press 'Numpad 8' to change toggle style to 'Long Range Weaves'. Press 'Numpad 9' to change toggle style to 'Support Weaves'. Press 'Numpad 5' to change toggle style to 'Advanced Weaves'. Press 'Numpad 6' to change toggle style to 'All Weaves'. If you ever realize that you lost your One Power item, click the 'M' key and it will reappear in your inventory."),
