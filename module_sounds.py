...
# ("fire_curtain",sf_priority_7|sf_vol_10, ["fire_curtain_2.wav"]),
 ...
 ("explosion",sf_priority_7|sf_vol_5, ["fl_pistol.wav"]),
 ("chain_lightning", sf_priority_7|sf_vol_10,["thunder_2.wav"]),
 ("balefire", sf_priority_7|sf_vol_11,["missile.wav"]),
 ("compulsion", sf_priority_7|sf_vol_11,["whip.wav"]),
 ("seeker", sf_priority_7|sf_vol_11,["zipper.wav"]),
 ("shield", sf_priority_7|sf_vol_11,["slap.wav"]),
 ("unravel", sf_priority_7|sf_vol_11,["whip_2.wav"]),
 # Trollocs
 ("encounter_trollocs",sf_2d|sf_vol_9, ["leopard7.wav"]),
 ("trolloc_die", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_hit", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_grunt", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_grunt_long", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_yell", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_stun", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 ("trolloc_victory", sf_priority_7|sf_vol_12,["bear_polar.wav","bear-roar.wav","crocodile.wav","crocodile2.wav","GOAT.wav","grizzlybear.wav","leopard7.wav","pig.wav","pigsnort.wav","Tiger2.wav","Tiger6.wav"]),
 # Myrdraal
 ("myrddraal_die", sf_priority_7|sf_vol_11,["snakehiss2.wav","snakehit.wav","snakeatt.wav"]),
 ("myrddraal_hit", sf_priority_7|sf_vol_11,["snakehiss2.wav","snakehit.wav","snakeatt.wav"]),
 ("myrddraal_grunt", sf_priority_7|sf_vol_11,["snakehiss2.wav","snakehit.wav","snakeatt.wav"]),
 ("myrddraal_grunt_long", sf_priority_7|sf_vol_11,["snakehiss2.wav","snakehit.wav","snakeatt.wav"]),
