...
##################### modified for TGS
      ...
      (else_try),
        ...
        (assign, ":cur_troop", "trp_shara_shbo_guardsman"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_26"),
        (assign, ":cur_troop", "trp_sea_folk_cargomaster"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_27"),
        (assign, ":cur_troop", "trp_madmen_air_shifter"),
      (else_try),
        (eq, "$g_quick_battle_team_2_faction", "fac_kingdom_28"),
        (assign, ":cur_troop", "trp_toman_head_city_guard"),
...
##### troop_ratio_bar (with added bar for channeling stamina)
#############################################################
  ("troop_ratio_bar_multiplayer",prsntf_read_only,0,[
      (ti_on_presentation_load,
       [
        ...
        (position_set_x, pos1, 840), # 30
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_111", pos1),
       
        (position_set_x, pos1, 845), # 35
        (position_set_y, pos1, 183), # 713
       
        (create_mesh_overlay, "$g_presentation_obj_112", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_112", 0x000000), # 0xAA1F1F
        (overlay_set_position, "$g_presentation_obj_112", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_113", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_113", 0x0099FF), # 0x1F1FAA
        (overlay_set_position, "$g_presentation_obj_113", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_114", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_114", 0x000000), # 0x1FAA1F
        (overlay_set_position, "$g_presentation_obj_114", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_115", "mesh_status_channeling_stamina_bar_button"),
        (position_set_x, pos1, 845), # 35  ###### from here ####
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_115", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_116", "mesh_status_channeling_stamina_bar_button"),
        (position_set_x, pos1, 977), # 275  ##### to here #### should have 132 difference #####
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_116", pos1),
        ...
        (create_mesh_overlay, "$g_presentation_obj_121", "mesh_weave_air_blast"),
        (overlay_set_position, "$g_presentation_obj_121", pos1),
        (overlay_set_size, "$g_presentation_obj_121", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_122", "mesh_weave_freeze_blast"),
        (overlay_set_position, "$g_presentation_obj_122", pos1),
        (overlay_set_size, "$g_presentation_obj_122", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_123", "mesh_weave_heal"),
        (overlay_set_position, "$g_presentation_obj_123", pos1),
        (overlay_set_size, "$g_presentation_obj_123", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_124", "mesh_weave_fire_ball"),
        (overlay_set_position, "$g_presentation_obj_124", pos1),
        (overlay_set_size, "$g_presentation_obj_124", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_125", "mesh_weave_unravel"),
        (overlay_set_position, "$g_presentation_obj_125", pos1),
        (overlay_set_size, "$g_presentation_obj_125", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_126", "mesh_weave_defensive_blast"),
        (overlay_set_position, "$g_presentation_obj_126", pos1),
        (overlay_set_size, "$g_presentation_obj_126", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_127", "mesh_weave_ranged_earth_blast"),
        (overlay_set_position, "$g_presentation_obj_127", pos1),
        (overlay_set_size, "$g_presentation_obj_127", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_128", "mesh_weave_bind"),
        (overlay_set_position, "$g_presentation_obj_128", pos1),
        (overlay_set_size, "$g_presentation_obj_128", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_129", "mesh_weave_chain_lightning"),
        (overlay_set_position, "$g_presentation_obj_129", pos1),
        (overlay_set_size, "$g_presentation_obj_129", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_130", "mesh_weave_fire_curtain"),
        (overlay_set_position, "$g_presentation_obj_130", pos1),
        (overlay_set_size, "$g_presentation_obj_130", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_131", "mesh_weave_shield"),
        (overlay_set_position, "$g_presentation_obj_131", pos1),
        (overlay_set_size, "$g_presentation_obj_131", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_132", "mesh_weave_seeker"),
        (overlay_set_position, "$g_presentation_obj_132", pos1),
        (overlay_set_size, "$g_presentation_obj_132", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_133", "mesh_weave_compulsion"),
        (overlay_set_position, "$g_presentation_obj_133", pos1),
        (overlay_set_size, "$g_presentation_obj_133", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_134", "mesh_weave_balefire"),
        (overlay_set_position, "$g_presentation_obj_134", pos1),
        (overlay_set_size, "$g_presentation_obj_134", pos2),

        (position_set_x, pos1, 860),
        (position_set_y, pos1, 205),
        
        (create_mesh_overlay, "$g_presentation_obj_135", "mesh_weave_select_non_ranged"),
        (overlay_set_position, "$g_presentation_obj_135", pos1),
        (overlay_set_size, "$g_presentation_obj_135", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_136", "mesh_weave_select_ranged"),
        (overlay_set_position, "$g_presentation_obj_136", pos1),
        (overlay_set_size, "$g_presentation_obj_136", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_137", "mesh_weave_select_support"),
        (overlay_set_position, "$g_presentation_obj_137", pos1),
        (overlay_set_size, "$g_presentation_obj_137", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_138", "mesh_weave_select_advanced"),
        (overlay_set_position, "$g_presentation_obj_138", pos1),
        (overlay_set_size, "$g_presentation_obj_138", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_139", "mesh_weave_select_all"),
        (overlay_set_position, "$g_presentation_obj_139", pos1),
        (overlay_set_size, "$g_presentation_obj_139", pos2),
...
#        (agent_get_wielded_item,":player_item_wielded",":player_agent",0),  # check weapon wielded in right hand
        ...
        (player_get_slot, ":weave_toggle_mode", ":player", slot_player_current_weave_toggle_mode),

            (position_set_x, pos1, 80), # 800
            (position_set_y, pos1, 120), # 1200
            ...
            (eq, ":active_channeling_weave", 1),
                (overlay_set_size, "$g_presentation_obj_121", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_121", pos2),
            ...
            (eq, ":active_channeling_weave", 2),
                (overlay_set_size, "$g_presentation_obj_122", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_122", pos2),
            ...
            (eq, ":active_channeling_weave", 3),
                (overlay_set_size, "$g_presentation_obj_123", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_123", pos2),
            ...
            (eq, ":active_channeling_weave", 4),
                (overlay_set_size, "$g_presentation_obj_124", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_124", pos2),
            ...
            (eq, ":active_channeling_weave", 5),
                (overlay_set_size, "$g_presentation_obj_125", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_125", pos2),
            ...
            (eq, ":active_channeling_weave", 6),
                (overlay_set_size, "$g_presentation_obj_126", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_126", pos2),
            ...
            (eq, ":active_channeling_weave", 7),
                (overlay_set_size, "$g_presentation_obj_127", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_127", pos2),
            ...
            (eq, ":active_channeling_weave", 8),
                (overlay_set_size, "$g_presentation_obj_128", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_128", pos2),
            ...
            (eq, ":active_channeling_weave", 9),
                (overlay_set_size, "$g_presentation_obj_129", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_129", pos2),
            ...
            (eq, ":active_channeling_weave", 10),
                (overlay_set_size, "$g_presentation_obj_130", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_130", pos2),
            ...
            (eq, ":active_channeling_weave", 11),
                (overlay_set_size, "$g_presentation_obj_131", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_131", pos2),
            ...
            (eq, ":active_channeling_weave", 12),
                (overlay_set_size, "$g_presentation_obj_132", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_132", pos2),
            ...
            (eq, ":active_channeling_weave", 13),
                (overlay_set_size, "$g_presentation_obj_133", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_133", pos2),
            ...
            (eq, ":active_channeling_weave", 14),
                (overlay_set_size, "$g_presentation_obj_134", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_134", pos2),
            ...
            (try_begin),
            (eq, ":weave_toggle_mode", 1),
                (overlay_set_size, "$g_presentation_obj_135", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_135", pos2),
                ...
                (overlay_set_size, "$g_presentation_obj_139", pos2),
            (else_try),
            (eq, ":weave_toggle_mode", 2),
                (overlay_set_size, "$g_presentation_obj_136", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_136", pos2),
                ...
                (overlay_set_size, "$g_presentation_obj_139", pos2),
            (else_try),
            (eq, ":weave_toggle_mode", 3),
                (overlay_set_size, "$g_presentation_obj_137", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_137", pos2),
                ...
                (overlay_set_size, "$g_presentation_obj_139", pos2),
            (else_try),
            (eq, ":weave_toggle_mode", 4),
                (overlay_set_size, "$g_presentation_obj_138", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_138", pos2),
                (overlay_set_size, "$g_presentation_obj_139", pos2),
            (else_try),
            (eq, ":weave_toggle_mode", 0),
                (overlay_set_size, "$g_presentation_obj_139", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_139", pos2),
        ...
        (try_begin),
          (eq, "$presentation_troop_ratio_bar_multiplayer_active", 1),
          (gt, ":cur_time", 200),
          (game_key_clicked, gk_view_orders),
          (assign, "$presentation_troop_ratio_bar_multiplayer_active", 0),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_battle"),
        (try_end),
        
    (try_end), # end client check
       ]),
...
##### troop_ratio_bar (with added bar for channeling stamina)
#############################################################
  ("troop_ratio_bar_multiplayer_2",prsntf_read_only,0,[
      (ti_on_presentation_load,
       [
        ...
        (position_set_x, pos1, 840), # 30
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_211", pos1),
       
        (position_set_x, pos1, 845), # 35
        (position_set_y, pos1, 183), # 713
       
        (create_mesh_overlay, "$g_presentation_obj_212", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_212", 0x000000), # 0xAA1F1F
        (overlay_set_position, "$g_presentation_obj_212", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_213", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_213", 0x0099FF), # 0x1F1FAA
        (overlay_set_position, "$g_presentation_obj_213", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_214", "mesh_channeling_white_plane"),
        (overlay_set_color, "$g_presentation_obj_214", 0x000000), # 0x1FAA1F
        (overlay_set_position, "$g_presentation_obj_214", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_215", "mesh_status_channeling_stamina_bar_button"),
        (position_set_x, pos1, 845), # 35  ###### from here ####
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_215", pos1),
       
        (create_mesh_overlay, "$g_presentation_obj_216", "mesh_status_channeling_stamina_bar_button"),
        (position_set_x, pos1, 977), # 275  ##### to here #### should have 132 difference #####
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_216", pos1),
        ...
        (create_mesh_overlay, "$g_presentation_obj_221", "mesh_weave_air_blast"),
        (overlay_set_position, "$g_presentation_obj_221", pos1),
        (overlay_set_size, "$g_presentation_obj_221", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_222", "mesh_weave_freeze_blast"),
        (overlay_set_position, "$g_presentation_obj_222", pos1),
        (overlay_set_size, "$g_presentation_obj_222", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_223", "mesh_weave_heal"),
        (overlay_set_position, "$g_presentation_obj_223", pos1),
        (overlay_set_size, "$g_presentation_obj_223", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_224", "mesh_weave_fire_ball"),
        (overlay_set_position, "$g_presentation_obj_224", pos1),
        (overlay_set_size, "$g_presentation_obj_224", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_225", "mesh_weave_unravel"),
        (overlay_set_position, "$g_presentation_obj_225", pos1),
        (overlay_set_size, "$g_presentation_obj_225", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_226", "mesh_weave_defensive_blast"),
        (overlay_set_position, "$g_presentation_obj_226", pos1),
        (overlay_set_size, "$g_presentation_obj_226", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_227", "mesh_weave_ranged_earth_blast"),
        (overlay_set_position, "$g_presentation_obj_227", pos1),
        (overlay_set_size, "$g_presentation_obj_227", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_228", "mesh_weave_bind"),
        (overlay_set_position, "$g_presentation_obj_228", pos1),
        (overlay_set_size, "$g_presentation_obj_228", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_229", "mesh_weave_chain_lightning"),
        (overlay_set_position, "$g_presentation_obj_229", pos1),
        (overlay_set_size, "$g_presentation_obj_229", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_230", "mesh_weave_fire_curtain"),
        (overlay_set_position, "$g_presentation_obj_230", pos1),
        (overlay_set_size, "$g_presentation_obj_230", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_231", "mesh_weave_shield"),
        (overlay_set_position, "$g_presentation_obj_231", pos1),
        (overlay_set_size, "$g_presentation_obj_231", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_232", "mesh_weave_seeker"),
        (overlay_set_position, "$g_presentation_obj_232", pos1),
        (overlay_set_size, "$g_presentation_obj_232", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_233", "mesh_weave_compulsion"),
        (overlay_set_position, "$g_presentation_obj_233", pos1),
        (overlay_set_size, "$g_presentation_obj_233", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_234", "mesh_weave_balefire"),
        (overlay_set_position, "$g_presentation_obj_234", pos1),
        (overlay_set_size, "$g_presentation_obj_234", pos2),

        (position_set_x, pos1, 860),
        (position_set_y, pos1, 205),
        
        (create_mesh_overlay, "$g_presentation_obj_235", "mesh_weave_select_non_ranged"),
        (overlay_set_position, "$g_presentation_obj_235", pos1),
        (overlay_set_size, "$g_presentation_obj_235", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_236", "mesh_weave_select_ranged"),
        (overlay_set_position, "$g_presentation_obj_236", pos1),
        (overlay_set_size, "$g_presentation_obj_236", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_237", "mesh_weave_select_support"),
        (overlay_set_position, "$g_presentation_obj_237", pos1),
        (overlay_set_size, "$g_presentation_obj_237", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_238", "mesh_weave_select_advanced"),
        (overlay_set_position, "$g_presentation_obj_238", pos1),
        (overlay_set_size, "$g_presentation_obj_238", pos2),
        
        (create_mesh_overlay, "$g_presentation_obj_239", "mesh_weave_select_all"),
        (overlay_set_position, "$g_presentation_obj_239", pos1),
        (overlay_set_size, "$g_presentation_obj_239", pos2),
...
#        (assign, ":total_count_WOT", ":maximum_channeling_stamina"),
        ...
        (position_set_x, pos1, 12000), # 12000
        (position_set_y, pos1, 300), # 300
        (overlay_set_size, "$g_presentation_obj_212", pos1),
        ...
        (position_set_x, pos1, ":channeling_stamina_percent"),
        (position_set_y, pos1, 300), # 300
        (overlay_set_size, "$g_presentation_obj_213", pos1),
        ...
        (position_set_x, pos1, ":channeling_stamina_percent_2"),
        (position_set_y, pos1, 300), #300
        (overlay_set_size, "$g_presentation_obj_214", pos1),
        ...
        (position_set_x, pos1, ":channeling_stamina_percent_3"),
        (position_set_y, pos1, 170), # 700
        (overlay_set_position, "$g_presentation_obj_217", pos1),
...
#        (agent_get_wielded_item,":player_item_wielded",":player_agent",0),  # check weapon wielded in right hand
        ...
        (player_get_slot, ":weave_toggle_mode", ":player", slot_player_current_weave_toggle_mode),
            ...
            (try_begin),
            (eq, ":active_channeling_weave", 1),
                (overlay_set_size, "$g_presentation_obj_221", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_221", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 2),
                (overlay_set_size, "$g_presentation_obj_222", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_222", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 3),
                (overlay_set_size, "$g_presentation_obj_223", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_223", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 4),
                (overlay_set_size, "$g_presentation_obj_224", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_224", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 5),
                (overlay_set_size, "$g_presentation_obj_225", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_225", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 6),
                (overlay_set_size, "$g_presentation_obj_226", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_226", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 7),
                (overlay_set_size, "$g_presentation_obj_227", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_227", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 8),
                (overlay_set_size, "$g_presentation_obj_228", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_228", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 9),
                (overlay_set_size, "$g_presentation_obj_229", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_229", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 10),
                (overlay_set_size, "$g_presentation_obj_230", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_230", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 11),
                (overlay_set_size, "$g_presentation_obj_231", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_231", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 12),
                (overlay_set_size, "$g_presentation_obj_232", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_232", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 13),
                (overlay_set_size, "$g_presentation_obj_233", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_233", pos2),
            ...
            (else_try),
            (eq, ":active_channeling_weave", 14),
                (overlay_set_size, "$g_presentation_obj_234", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_234", pos2),
            ...
            (try_begin),
            (eq, ":weave_toggle_mode", 1),
                (overlay_set_size, "$g_presentation_obj_235", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_235", pos2),
            ...
            (else_try),
            (eq, ":weave_toggle_mode", 2),
                (overlay_set_size, "$g_presentation_obj_236", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_236", pos2),
            ...
            (else_try),
            (eq, ":weave_toggle_mode", 3),
                (overlay_set_size, "$g_presentation_obj_237", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_237", pos2),
            ...
            (else_try),
            (eq, ":weave_toggle_mode", 4),
                (overlay_set_size, "$g_presentation_obj_238", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_238", pos2),
            ...
            (else_try),
            (eq, ":weave_toggle_mode", 0),
                (overlay_set_size, "$g_presentation_obj_239", pos1),
...
#                (overlay_set_size, "$g_presentation_obj_239", pos2),
        ...
        (try_begin),
          (eq, "$presentation_troop_ratio_bar_multiplayer_2_active", 1),
          (gt, ":cur_time", 200),
          (game_key_clicked, gk_view_orders),
          (assign, "$presentation_troop_ratio_bar_multiplayer_2_active", 0),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_battle"),
        (try_end),
